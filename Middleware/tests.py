...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'am_nexus.settings')  # Replace with your project name
django.setup()

from coins.models import Job, Project
from datetime import date
from forms.models import Qaqc1001Response
...
def insert_project():
    ...
    print(f"Inserted Project with ID {job.ctt_code} and Name {job.job_shipaddr_1}")
